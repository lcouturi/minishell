...
PARSER =  arg_splitter escape_split expand_envvar expand_wildcard get_arg_num get_file_list get_length is load_lst parser rm_quotes
...
clean :
	...
	@rm -rf $(OBJS) "<" ">" ">>" "asd" "grep" "lol" minishell_test.log
