...
SRCS = main.c signal.c cmd/cd.c cmd/exec.c cmd/exit.c cmd/env.c cmd/pwd.c cmd/echo.c cmd/unset.c parser/arg_splitter.c parser/expand_envvar.c parser/expand_wildcard.c parser/parser.c \
