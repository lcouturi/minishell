...
CMD = cd echo env exec exec_proc exit export pwd unset
PARSER =  escape escape_split expand_envvar expand_wildcard get_arg_num get_file_list get_length is load_lst parser rm_quotes
...
clean :
	...
	@rm -rf $(OBJS) "<" ">" ">>" .temp asd echo grep lol minishell_test.log tmp_*
